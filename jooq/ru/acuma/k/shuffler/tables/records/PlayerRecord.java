...
public class PlayerRecord extends UpdatableRecordImpl<PlayerRecord> implements Record5<Long, Long, Long, Integer, String> {
    ...
    @Override
    public PlayerRecord values(Long value1, Long value2, Long value3, Integer value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PlayerRecord(Long id, Long chatId, Long userId, Integer rating, String discipline) {
        super(Player.PLAYER);
