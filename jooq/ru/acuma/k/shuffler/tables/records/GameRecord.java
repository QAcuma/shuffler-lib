...
public class GameRecord extends UpdatableRecordImpl<GameRecord> implements Record8<Long, Long, Integer, OffsetDateTime, OffsetDateTime, Long, Long, String> {
    ...
    @Override
    public Row8<Long, Long, Integer, OffsetDateTime, OffsetDateTime, Long, Long, String> valuesRow() {
    ...
    @Override
    public GameRecord values(Long value1, Long value2, Integer value3, OffsetDateTime value4, OffsetDateTime value5, Long value6, Long value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GameRecord(Long id, Long eventId, Integer index, OffsetDateTime startedAt, OffsetDateTime finishedAt, Long winnerTeamId, Long loserTeamId, String discipline) {
        super(Game.GAME);
