...
public class TeamPlayer extends TableImpl<TeamPlayerRecord> {
     ...
     */
    public final TableField<TeamPlayerRecord, Long> PLAYER_ID = createField(DSL.name("player_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.team_player.team_id</code>.
     */
    public final TableField<TeamPlayerRecord, Long> TEAM_ID = createField(DSL.name("team_id"), SQLDataType.BIGINT, this, "");
