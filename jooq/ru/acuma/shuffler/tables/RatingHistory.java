...
public class RatingHistory extends TableImpl<RatingHistoryRecord> {
    ...
    /**
     * The column <code>public.rating_history.event_id</code>.
     */
    public final TableField<RatingHistoryRecord, Long> EVENT_ID = createField(DSL.name("event_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<ForeignKey<RatingHistoryRecord, ?>> getReferences() {
        return Arrays.asList(Keys.RATING_HISTORY__FK_EXISTS_EVENT, Keys.RATING_HISTORY__FK_EXISTS_GAME, Keys.RATING_HISTORY__FK_EXISTS_PLAYER);
    }
    ...
    public Event event() {
        if (_event == null)
            _event = new Event(this, Keys.RATING_HISTORY__FK_EXISTS_EVENT);
