...
public class RatingHistoryRecord extends UpdatableRecordImpl<RatingHistoryRecord> implements Record7<Long, Long, Long, Integer, Integer, Long, Boolean> {
    ...
    @Override
    public Row7<Long, Long, Long, Integer, Integer, Long, Boolean> valuesRow() {
    ...
    public Field<Boolean> field7() {
        return RatingHistory.RATING_HISTORY.ISCALIBRATED;
    }
    ...
    @Override
    public RatingHistoryRecord values(Long value1, Long value2, Long value3, Integer value4, Integer value5, Long value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RatingHistoryRecord(Long id, Long gameId, Long playerId, Integer change, Integer score, Long seasonId, Boolean iscalibrated) {
        super(RatingHistory.RATING_HISTORY);
