...
public class RatingHistoryRecord extends UpdatableRecordImpl<RatingHistoryRecord> implements Record5<Long, Long, Long, Integer, Integer> {
    ...
    @Override
    public RatingHistoryRecord values(Long value1, Long value2, Long value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RatingHistoryRecord(Long id, Long gameId, Long playerId, Integer change, Integer score) {
        super(RatingHistory.RATING_HISTORY);
