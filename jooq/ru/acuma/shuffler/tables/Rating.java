...
public class Rating extends TableImpl<RatingRecord> {
    ...
    /**
     * The column <code>public.rating.multiplier</code>.
     */
    public final TableField<RatingRecord, BigDecimal> MULTIPLIER = createField(DSL.name("multiplier"), SQLDataType.NUMERIC.nullable(false).defaultValue(DSL.field("1", SQLDataType.NUMERIC)), this, "");
