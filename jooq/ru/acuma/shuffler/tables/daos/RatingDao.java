...
public class RatingDao extends DAOImpl<RatingRecord, ru.acuma.shuffler.tables.pojos.Rating, Long> {
     ...
     * upperInclusive</code>
     */
    public List<ru.acuma.shuffler.tables.pojos.Rating> fetchRangeOfMultiplier(BigDecimal lowerInclusive, BigDecimal upperInclusive) {
        return fetchRange(Rating.RATING.MULTIPLIER, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>multiplier IN (values)</code>
     */
    public List<ru.acuma.shuffler.tables.pojos.Rating> fetchByMultiplier(BigDecimal... values) {
        return fetch(Rating.RATING.MULTIPLIER, values);
    }
}
