...
public class Keys {
    ...
    public static final ForeignKey<EventRecord, GroupInfoRecord> EVENT__FK_EXISTS_CHAT = Internal.createForeignKey(Event.EVENT, DSL.name("fk_exists_chat"), new TableField[] { Event.EVENT.CHAT_ID }, Keys.GROUP_INFO_PKEY, new TableField[] { GroupInfo.GROUP_INFO.ID }, true);
    ...
    public static final ForeignKey<PlayerRecord, GroupInfoRecord> PLAYER__FK_EXISTS_CHAT = Internal.createForeignKey(Player.PLAYER, DSL.name("fk_exists_chat"), new TableField[] { Player.PLAYER.CHAT_ID }, Keys.GROUP_INFO_PKEY, new TableField[] { GroupInfo.GROUP_INFO.ID }, true);
    public static final ForeignKey<PlayerRecord, UserInfoRecord> PLAYER__FK_EXISTS_USER = Internal.createForeignKey(Player.PLAYER, DSL.name("fk_exists_user"), new TableField[] { Player.PLAYER.USER_ID }, Keys.USER_INFO_PKEY, new TableField[] { UserInfo.USER_INFO.ID }, true);
