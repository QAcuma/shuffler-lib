...
public class Keys {
    ...
    public static final ForeignKey<RatingHistoryRecord, EventRecord> RATING_HISTORY__FK_EXISTS_EVENT = Internal.createForeignKey(RatingHistory.RATING_HISTORY, DSL.name("fk_exists_event"), new TableField[] { RatingHistory.RATING_HISTORY.EVENT_ID }, Keys.EVENT_PKEY, new TableField[] { Event.EVENT.ID }, true);
